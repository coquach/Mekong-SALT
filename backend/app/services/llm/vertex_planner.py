...
class VertexPlanPromptBuilder:
    ...
    def build(self, *, objective: str, context: dict[str, Any]) -> str:
        ...
        return (
            ...
            "- When salinity is falling and the context suggests recovery, prefer open_gate for a danger-level plan and follow it with wait-safe-window or monitoring rather than escalating to closure.\n"
            ...
            "- Make summary 2 to 4 Vietnamese sentences, roughly 80 to 120 words, with this structure: what the current risk is, what evidence supports that assessment, and what mitigation or next operational action is recommended.\n"
            "- If the context contains station or region identifiers, refer to them naturally in the summary when helpful. Avoid one-line boilerplate.\n"
            "- Keep reasoning_summary concise, operational, and distinct from summary.\n"
