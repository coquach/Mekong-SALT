...
export const APP_ROUTES: AppRouteMeta[] = [
  ...
  {
    path: "/strategy",
    navLabel: "Điều phối chiến lược",
    title: "Điều phối chiến lược",
    subtitle: "Duyệt goal, plan và run trace theo vòng vận hành",
    keyQuestion: "Cần duyệt kế hoạch nào và vì sao?",
    realtimeMode: "polling",
  },
  {
    path: "/logs",
    navLabel: "Nhật ký hành động",
    title: "Nhật ký thực thi hành động",
    subtitle: "Theo dõi batch execution, outcome và feedback lifecycle",
    keyQuestion: "Hành động đã chạy tới đâu và kết quả ra sao?",
    realtimeMode: "polling",
  },
  {
    path: "/history",
