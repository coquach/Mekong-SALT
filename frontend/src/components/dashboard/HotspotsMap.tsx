...
const HotspotMarker = ({ top, left, label, intensity = 'critical' }: { 
  top: string, 
  left: string, 
  label: string, 
...
export const HotspotsMap = () => {
  return (
    ...
    >
      ...
      <HotspotMarker top="45%" left="42%" label="Hòa Định Sluice Gate" intensity="critical" />
      <HotspotMarker top="60%" left="55%" label="Bến Tre Station 04" intensity="warning" />
      <HotspotMarker top="35%" left="68%" label="Tiền Giang Estuary" intensity="critical" />
